...
\title{Data Warehouses:\\ HP Vertica e armazenamento coluanar}
...
A arquitetura da ferramenta é definida em 4 camadas:
...
SpagoBI é uma plataforma completa de integração para \textit{Buisiness Intelligence}, cobrindo toda a extensão de necessidades de análise, incluindo ETL, OLAP e \textbf{data mining}. Esta integração é feita através de \textit{engines}, possibilitando que o usuário escolha quais ferramentas devem compor sua plataforma \cite{gioia2008spagobi}. As ferramentas que compõe os diversos módulos da SpagoBI podem ser parte do projeto SpagoBI, ferramentas de outros projetos de Licenças Livres ou variações de tais projetos \cite{golfarelli2009open}

A arquitetura da ferramenta é definida em 3 camadas:
